...
path1 = r'C:\Users\Tisdalege\Desktop\Data\B_B04_HMM'
folder = r'\Only_Data'
...
burst_count_number_img = 0
burst_count_number_img_view = 1
...
for i in range(1, burst_count_number_img_view):
    if i == 1:
...
with open("Data_Matrix.csv", "wb") as f:
    writer = csv.writer(f)
