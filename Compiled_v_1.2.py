...
path1 = r'C:\Users\tisdalege\Desktop\Organized Data\1_A_C05_HMM_Data'
folder = r'\Only_Data'
...
#            plt.close()
            ...
            Burst_Name = data_set_name + str(end_list[trk_count]) + '_Burst_Number_' + str(burst_count_number_img_view)
...
with open("Data_Matrix_csv_test_intensity.csv", "wb") as f:
    writer = csv.writer(f)
    writer.writerows(np.vstack((header_array, matrix1.transpose())))


with open("Data_Matrix_csv_test_frames.csv", "wb") as f:
    writer = csv.writer(f)
